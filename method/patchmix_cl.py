...
class PatchMixConLoss(nn.Module):
    ...
    def forward(self, projection1, projection2, labels_a, labels_b, lam, index_combinations, args):
        ...
        logits_max1, _ = torch.max(anchor_dot_contrast, dim=1, keepdim=True)
        logits = anchor_dot_contrast - logits_max1.detach() # for numerical stability
